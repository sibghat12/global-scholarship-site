...
<section id="scholarship-coverage" class="gs-scholarship-coverage">
    ...
    <?php 
        if(count($coverage) == 1 ) : ?>
            <p>This <?php echo get_adjective_scholarship_amount($scholarship_type); ?> scholarship for international students covers <?php echo $coverage[0]['coverage']; ?>.</p>
            
        <?php elseif(count($coverage) > 1 ) : ?>
            <p>This fully-funded scholarship for international students covers the following:</p>
            <ul class="fa-ul">
