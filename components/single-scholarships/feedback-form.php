 <div class="gs-feedback-form-container">
   <form id="gs-feedback-form" action="" method="POST" class="gs-feedback-form">
    ...
    <div class="step-2" data-feedback-type="scholarship-information">
      ...
      <textarea name="incorrect_info_improvement" rows="5"placeholder="What information is incorrect?" ></textarea>
      <label class="gs-feedback-radio-label">
      ...
      <textarea name="outdated_info_improvement" rows="5"placeholder="What information is outdated?" ></textarea>
      <label class="gs-feedback-radio-label">
      ...
      <textarea name="not_for_international_improvement" rows="5"placeholder="What is the reason why this scholarship is not for international students?" ></textarea>
    ...
    <div class="step-2" data-feedback-type="page-content">
      ...
      <textarea name="not_easy_to_read_improvement" rows="5"placeholder="What specific sentences or paragraphs are difficult to read?" ></textarea>
      <label class="gs-feedback-radio-label">
      ...
      <textarea name="details_missing_improvement" rows="5"placeholder="What information is missing?" ></textarea>
      <label class="gs-feedback-radio-label">
      ...
      <textarea name="not_clear_procedures_improvement" rows="5"placeholder="What specific parts of the application procedures are unclear?" ></textarea>
      <input type="hidden" name="current_scholarship_info" data-scholarship-url="<?php echo get_permalink( get_the_ID() ); ?>" data-scholarship-id="<?php echo get_the_ID(); ?>" data-scholarship-title="<?php echo get_the_title(); ?>" data-scholarship-edit-page-url="<?php echo get_edit_post_link(get_the_ID()); ?>">
    </div>
    <div class="step-2" data-feedback-type="suggestions">
      ...
      <textarea name="suggestion_improvement" rows="5"placeholder="Please write your suggestions." ></textarea>
      <input type="hidden" name="current_scholarship_info" data-scholarship-url="<?php echo get_permalink( get_the_ID() ); ?>" data-scholarship-id="<?php echo get_the_ID(); ?>" data-scholarship-title="<?php echo get_the_title(); ?>" data-scholarship-edit-page-url="<?php echo get_edit_post_link(get_the_ID()); ?>">
    </div>
