...
<?php
 if ($country_name == "United Kingdom") {?>
    ...
    <p>With that said, are you interested in studying in the US, as well? If you are, you might want to consider going to <?php echo $institution_title; ?>, a premier institution in <?php echo $city_name . ", " . $country_name; ?>. You’ll be joining the <?php echo $total_students_formatted; ?> students who go there every year.</p>
    ...
    <p>Thus, if you’ve been thinking about studying at SK, you should go for it! You can choose from many institutions, such as the <?php echo $institution_title; ?> in <?php echo $city_name . ", " . $country_name; ?>. It was established in <?php echo $founded_year; ?> and welcomes <?php echo $total_students_formatted; ?> students every year.</p>
    ...
    <p>
    For years, Australia has welcomed thousands of international students. It's not just the amazing sites that draw these people. Australian institutions have been joining the top spots of world university rankings. Therefore, you’ll be receiving top-tier education if you go there. 
    </p>

    <p>
    As said, there are many highly recognized institutions in Australia, and one of them is the  <?php echo $institution_title; ?> in <?php echo $city_name . ", " . $country_name; ?>. It was founded in <?php echo $founded_year; ?> and serves as the second home to  <?php echo $total_students_formatted; ?> students.
    </p>
    ...
    <p><?php echo $institution_title; ?> is a premier <?php echo $type; ?> institution you can find in <?php echo $city_name . ", " . $country_name; ?>. It was founded in <?php echo $founded_year; ?>, and has since molded young learners to become smart contributors to the modern world. Annually, it welcomes around <?php echo $total_students_formatted; ?> students.</p>

    <?php } else if ($country_name == "China"){?>
    ...
    <p>With that said, you really should consider <?php echo $institution_title; ?>. This Chinese academe was founded in <?php echo $founded_year; ?> and currently located in <?php echo $city_name . ", " . $country_name; ?>. It is said to welcome <?php echo $total_students_formatted; ?> students per year, and soon you can be one of them, too!</p>
    ...
    <p>The institution welcomes <?php echo $total_students_formatted; ?> students per year. These students can choose from many programs, such as <?php echo $degrees_text; ?>. You can easily be one of them soon!</p>
    
    <?php } else if ($country_name == "Sweden"){?>
    <p>Indulge yourself with breathtaking lake views and forests in Sweden! The country is the home of many world-class universities, including <?php echo $institution_title; ?>. With over <?php echo $total_students_formatted; ?> students from different places around the globe, the <?php echo $institution_title; ?> offers a welcoming place and a huge opportunity for individuals to grow and thrive in their chosen careers.</p>
    ...
    <?php } else if ($country_name == "New Zealand"){?>

    <p>Breathe the refreshing air and explore the exhilarating sites of New Zealand while you study there! The archipelago is home to <?php echo $institution_title; ?>, which welcomes <?php echo $total_students_formatted; ?> students annually, and you can be one of them!</p>

    <p><?php echo $institution_title; ?> is in <?php echo $city_name . ", " . $country_name; ?> and was founded in <?php echo $founded_year; ?>. It is known for its programs like <?php echo $degrees_text; ?>. Its facilities and educators are also worldclass, so you’re sure to experience quality training that will propel your career and expand your knowledge. </p>

    <?php } else if ($country_name == "Switzerland"){?>
    ...
    <?php } else if ($country_name == "Poland"){?>
    ...
    <p><?php echo $institution_title; ?> is one of Poland's esteemed universities. Since its establishment in <?php echo $founded_year; ?>, it has been at the forefront of delivering quality training that boosts the intelligence and knowledge of its students. At the moment, the university holds over <?php echo $total_students_formatted; ?> students annually.</p>

    <?php } else if ($country_name == "Ireland"){?>
    ...
    <p>Opened in <?php echo $founded_year; ?>, <?php echo $institution_title; ?> continuously attracts international students due to its quality education, and diverse community. It is located in <?php echo $city_name . ", " . $country_name; ?>, with over <?php echo $total_students_formatted; ?> students enrolled annually. <?php echo $institution_title; ?> aims to provide the best training to its students by having facilities, laboratories, and infrastructures that can aid their learning. </p>
    
    <?php } else if ($country_name == "France"){?>
    ...
    <p>Speaking of iconic universities, <?php echo $institution_title; ?> is an institution located at <?php echo $city_name . ", " . $country_name; ?>. It is the home of <?php echo $total_students_formatted; ?> students coming from different parts of the world. As an international student at <?php echo $institution_title; ?>, you’ll surely get the utmost quality for your education!</p>
    
    <?php } else if ($country_name == "Italy"){?>
    ...
    <?php } else if ($country_name == "Germany"){?>
    ...
    <p>If you wish to experience the life of an international student in Germany, consider enrolling in <?php echo $institution_title; ?>, which is in <?php echo $city_name . ", " . $country_name; ?>. It welcomes <?php echo $total_students_formatted; ?> of students every year since it was founded in <?php echo $founded_year; ?>. Thus, you’re sure to find people who you can relate with and contribute to your growth.</p>

    <?php } else if ($country_name == "Singapore"){?>
    ...
    <?php } else if ($country_name == "Greece"){?>
    ...
    <p>Do all those sound too good? Discover for yourself by attending <?php echo $institution_title; ?>, a Greek university you may find in <?php echo $city_name . ", " . $country_name; ?>. It’s been molding students since <?php echo $founded_year; ?>, which has since grown to <?php echo $total_students_formatted; ?> annually. Don’t miss the opportunity to be one of them!</p>

        
    <?php } else if ($country_name == "Norway"){?>
    ...
    <p>To benefit from all those, enroll at <?php echo $institution_title; ?>. This institution in <?php echo $city_name . ", " . $country_name; ?> welcomes <?php echo $total_students_formatted; ?>  students per year, and you can easily be one of them as there are several programs offered. Thus, you can take your pick from <?php echo (isset($bachelor_courses_string) && !empty($bachelor_courses_string)) ? $bachelor_courses_string : ((isset($master_courses_string) && !empty($master_courses_string)) ? $master_courses_string : ''); ?>, and more!</p>
    ...
    <p>Experience that unique learning experience yourself by studying at <?php echo $institution_title; ?>, a Dutch institution that has been active since <?php echo $founded_year; ?>. It is in <?php echo $city_name . ", " . $country_name; ?> and welcomes  <?php echo $total_students_formatted; ?>  students annually, who could be your chums should you go here! </p>

    <?php } else if ($country_name == "India"){?>
    ...
    <p>Among those top-tier institutions is <?php echo $institution_title; ?>. It hosts <?php echo $total_students_formatted; ?> students every year, and you can be one of them soon! You only have to comply with the admission requirements, and you’ll see yourself heading to <?php echo $city_name . ", " . $country_name; ?>, which is where the institution is located.</p>

    <?php } else if ($country_name == "Philippines"){?>
    ...
    <p>Also, there are many reputed institutions you can go to if you choose to be an international student in the Philippines. One of them is [university], which is in <?php echo $city_name . ", " . $country_name; ?> and was founded in <?php echo $founded_year; ?>. Simply comply with admission requirements, and you can join its population of <?php echo $total_students_formatted; ?> students.</p>
    ...
    <p>To become an international student in Spain, you’ll need to pick a university. If you haven’t chosen one, consider <?php echo $institution_title; ?> in <?php echo $city_name . ", " . $country_name; ?>. This institution, which was established in <?php echo $founded_year; ?>, offers courses in <?php echo (isset($bachelor_courses_string) && !empty($bachelor_courses_string)) ? $bachelor_courses_string : ((isset($master_courses_string) && !empty($master_courses_string)) ? $master_courses_string : ''); ?>, and other fields. Even when you’re thousand of miles from home, you won’t feel alone here as there’s a bustling crowd of <?php echo $total_students_formatted; ?> students.</p>

    <?php } else if ($country_name == "Portugal"){?>
    ...
    <p>If you’ve made up your mind to study in Portugal, apply to <?php echo $institution_title; ?>. It’s a top-tier institution established in <?php echo $founded_year; ?>. It is situated in <?php echo $city_name . ", " . $country_name; ?>, where most of its <?php echo $total_students_formatted; ?> students congregate and learn.</p>

    <?php } else if ($country_name == "South Africa"){?>

    <p>Have you always dreamed of exploring South Africa? Well, you can do that while learning if you’re an international student at <?php echo $institution_title; ?>. As its student, you’ll find yourself at home in <?php echo $city_name . ", " . $country_name; ?> with <?php echo $total_students_formatted; ?> other learners.</p>
    ...
    <?php } else if ($country_name == "Russia"){?>
    ...
    <p>One of the institutions they were able to do all that in was <?php echo $institution_title; ?>. It’s situated in <?php echo $city_name . ", " . $country_name; ?> and was founded in <?php echo $founded_year; ?>. Annually, it expects <?php echo $total_students_formatted; ?> students, and you can become one of them! If you request admission there, don’t forget to try applying for funding.</p>
    
    <?php } else if ($country_name == "Czech Republic"){?>
    ...
    <?php } else if ($country_name == "Austria"){?>
    ...
    <p>You have a choice of many academic institutions there, but you may want to consider <?php echo $institution_title; ?>, which was founded in [year]. Once admitted, you’ll find yourself charmed by its campus in <?php echo $city_name . ", " . $country_name; ?>. You’ll also find yourself enthralled amidst the crowd of <?php echo $total_students_formatted; ?> students.</p>
    
    <?php } else if ($country_name == "Finland"){?>
