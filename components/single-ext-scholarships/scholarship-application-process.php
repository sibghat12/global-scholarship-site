<section id="scholarship-application-procedure" class="gs-scholarship-application-process">
    ...
    <?php if(isset($application_requirements)) : ?>
        <div class="gs-ext-schoalrship-application-requirements">
            ...
            <?php // Scholarship Application Requirements  ?>

                <ul class="fa-ul">
                    <?php foreach($application_requirements as $requirement) : ?>
    ...
    <?php endif; ?>
    <?php if(isset($application_procedures)) : ?>
