...
if($count % 3 == 1 && $program =="undergraduate") { ?>
    ...
    This is one of the most generous scholarships at the <?php echo  $institution_title ?>.</p>
    <?php }else { ?>
    </p>
    <?php } ?>

    <?php if ($show_eligibility){ ?>
    <p> To be considered for this undergraduate scholarship at <?php echo $institution_title ?>, 
...
if($count % 3 == 2 &&  $program =="undergraduate") { ?>
    ...
    <p>Another undergraduate scholarship for international students worth checking at <?php   echo $institution_title; ?> is 
...
Interested applicants for this <?php echo get_adjective_scholarship_amount($scholarship_category) ?> scholarship must meet the following certain eligibility requirements 
    ...
    <p>  Through <b><a href="<?php echo get_permalink($id)?>"><?php echo $scholarship_name ?></a></b>, <?php echo $eligible_degrees; ?> students at the <?php echo $institution_title; ?> enjoy the following benefits: </p>
    <?php echo  get_scholarship_criteria_coverage($coverage, "coverage", get_the_ID());  ?>
...
if($count % 3 == 2 && $program=="graduate"){ ?>
  ...
  <p>  <b><a href="<?php echo get_permalink($id)?>"><?php echo   $scholarship_name ?></a></b> is open to  <?php echo $eligible_degrees ?> international students who meet the following eligibility requirements: </p>
    ...
    <p>  <?php echo  $institution_title ?> awards the following scholarship benefits to successful applicants: </p>
...
Students need to meet the following requirements to be eligible: </p>
    ...
    you pursue your <?php echo $eligible_degrees; ?> degree at <?php echo  $institution_title; ?>. </p>

    <?php } if($scholarship_category== "Partial Funding") { ?>
    
    <p> There are other fees to pay for, but getting this scholarship will still help you financially as an <?php  $eligible_degrees ?> international student at <?php echo $institution_title; ?>.   </p>
