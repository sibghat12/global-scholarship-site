...
function theme_enqueue_styles() {
    wp_enqueue_style( 'dashicons' );
     ...
     wp_enqueue_style( 'course_button_shortcode', get_stylesheet_directory_uri() . '/assets/dist/css/course_button_shortcode.css', [], '1.0.0' );
    ...
    wp_enqueue_style('avada-child-style', get_stylesheet_directory_uri() . '/style.css', [], '1.0.1');
    ...
    if (is_front_page()) {
        wp_enqueue_style( 'homepage-css', get_stylesheet_directory_uri() . '/assets/dist/css/homepage_template.css', [], '1.0.0' );
    } 

    if (is_page('email-subscription-page')) {
        wp_enqueue_style( 'email_subscription-page-css', get_stylesheet_directory_uri() . '/assets/dist/css/email_subscription_page.css', [], '1.0.0' );
    }  
    ...
    if(is_page('partner-with-us')){
         wp_enqueue_style( 'partner-template-css', get_stylesheet_directory_uri() . '/assets/dist/css/partner_template.css', [], '1.0.0' );
    }

    $page_template_slug = get_page_template_slug();
    if (is_page_template('templates/template-currently-open-scholarship.php')) {
        wp_enqueue_style( 'currently-open-scholarship-template', get_stylesheet_directory_uri() . '/assets/dist/css/currently_open_template.css', [], '1.0.0' );
    }
    
    if (is_page('recent-scholarship-posts')) {
    wp_enqueue_style( 'recent_scholarship_receipents', get_stylesheet_directory_uri() . '/assets/dist/css/recent_scholarship_receipents.css', [], '1.0.0' );
    ...
    $current_url = $_SERVER['REQUEST_URI'];
     if (strpos($current_url, '/scholarship-category/') !== false) {
    ...
    if(is_page('opencourses')){
         wp_enqueue_style( 'opencourses-template-css', get_stylesheet_directory_uri() . '/assets/dist/css/opencourses_template.css', [], '1.0.0' );
    } 

    if(is_page('scholarship-search') || is_404()){
         wp_enqueue_style( 'scholarship-filter-css', get_stylesheet_directory_uri() . '/assets/dist/css/scholarship_search_filter.css', [], '1.0.0' );
    } 

    if(is_singular('scholarships')) {
        wp_enqueue_style( 'single-scholarship-css', get_stylesheet_directory_uri() . '/assets/dist/css/single_scholarships.css', [], '1.0.0' );
    }

    if(is_singular('ext-scholarships')) {
        wp_enqueue_style( 'external-scholarships-css', get_stylesheet_directory_uri() . '/assets/dist/css/single_external_scholarships.css', [], '1.0.0' );
    }
   ...
   if ( is_singular('institution') || is_singular('scholarships') || is_singular("ext-scholarships")) {
    ...
    wp_enqueue_style( 'gs-single_scholarship_post', get_stylesheet_directory_uri() . '/assets/dist/css/single_scholarships_post.css', [], '1.0.0' );
    ...
    wp_enqueue_script(
        ...
        get_stylesheet_directory_uri() . '/assets/update-scholarships.js',
        array('jquery'),
        '1.0.45',
        false
    );
    ...
    wp_enqueue_script(
        'gs_modal-login',
        get_stylesheet_directory_uri() . '/assets/login-modal.js',
        array('jquery', 'google-platform'),
        '1.0.45',
        true
    );
    ...
    wp_enqueue_script(
        'gs_modal-signup',
        get_stylesheet_directory_uri() . '/assets/signup-modal.js',
        array('jquery', 'gs_select2-script', 'google-platform'),
        time(),
        true
    );
...
function enqueue_scholarship_admin_scripts($hook_suffix)
{
    ...
    if ($hook_suffix == 'institution_page_acf-options-update-institutions-deadlines') {
        ...
        wp_enqueue_script(
            'gs_institutions_update',
            get_stylesheet_directory_uri() . '/assets/institutions-deadlines.js',
            array('jquery'),
            '1.0.45',
            false
        );
    ...
    if ($hook_suffix == 'institution_page_institutions-deadlines-updated') {
        ...
        wp_enqueue_script(
            'gs_deadlines_updated_script',
            get_stylesheet_directory_uri() . '/assets/institutions-updated-deadlines.js',
            array('jquery', 'deadlines_datatables-js'),
            '1.0.45',
            false
        );
    ...
    if (is_object($screen) && $screen->id === 'ext-scholarships') { // Replace 'your_custom_post_type' with your specific custom post type
        ...
        wp_enqueue_script(
            'gs_ext_scholarship_acf',
            get_stylesheet_directory_uri() . '/assets/ext-scholarship-update-include-exclude.js',
            array('jquery'),
            '1.0.0',
            false
        );
...
function add_noindex_for_scholarships() {
    if (is_singular('scholarships')) {
        ...
        if ($should_index !== '1') { // Check if it's not set to '1'
