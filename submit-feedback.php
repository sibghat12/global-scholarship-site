...
function process_feedback_form() {
    ...
    $feedback_data = array(
        ...
        'not_for_international_improvement' => (isset($_POST['not_for_international_improvement']) && sanitize_text_field($_POST['improvement']) == 'not_for_international' ) ? sanitize_text_field($_POST['not_for_international_improvement']) : '',
