...
// add_action('wp_ajax_set_title', 'my_set_title');
// add_action('wp_ajax_nopriv_set_title', 'my_set_title');

// function my_set_title() {
//     // Get the new title from the AJAX request.
//     $new_title = sanitize_text_field($_POST['title']);

//     // Modify the title using Rank Math filter
//     add_filter('rank_math/frontend/title', function($title) use ($new_title) {
//         $title = $new_title;
//         return $title;
//     });
...
add_action('init', 'custom_template_redirect');