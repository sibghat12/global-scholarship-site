...
<div class="mp_wrapper mp_login_form">
  ...
  <?php else: ?>
    ...
    <form name="mepr_loginform" id="mepr_loginform" class="mepr-form" action="<?php echo esc_url($login_url); ?>" method="post">
      ...
      <div class="gs-memberpress-login-actions">
        <label class="gs-memberpress-login-remember"><input name="rememberme" type="checkbox" id="rememberme" value="forever"<?php checked(isset($_REQUEST['rememberme'])); ?> /> <?php _ex('Remember Me', 'ui', 'memberpress'); ?></label>

        <div class="mepr-login-actions">
            <a class="gs-memberpress-login-forget-password" href="<?php echo esc_url($forgot_password_url); ?>"><?php _ex('Forgot Password?', 'ui', 'memberpress'); ?></a>
        </div>
      </div>
      <div class="mp-spacer">&nbsp;</div>
      <div class="submit">
        <input type="submit" name="wp-submit" id="wp-submit" class="button-primary gs-mepr-login mepr-share-button " value="<?php _ex('Continue', 'ui', 'memberpress'); ?>" />
